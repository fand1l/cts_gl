...
* **QR-код отримує кнопку прямо на собі.** Будь-який код на застиглому екрані
  читається там, де він є, і носить маленьку кнопку з сайтом, куди веде, —
  натиснули й ви там. Розшифровується на вашій машині, десь за мілісекунду, і
  нічого з нього не вивантажується. Два коди — дві кнопки, бо одна не може
  сказати, який саме має на увазі.
...
| **Натисніть код** | кожен QR на екрані носить кнопку з тим, куди веде |
...
копіює, а *Ctrl* із перетягуванням виносить картинку просто в чат чи документ.
Стає в пригоді щоразу, коли те, що треба прочитати, за вікном, у яке треба
друкувати.
