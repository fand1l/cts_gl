...
* **Виділити текст на застиглому екрані** й скопіювати його так, щоб нічого не
  залишало машину — необовʼязкове локальне розпізнавання, вимкнене, доки ви його
  не ввімкнете.
...
| | |
|---|---|
| ![Мить перед малюванням](docs/images/overlay-start-uk.png) **Потрясли — екран застиг.** Ласо або прямокутник: чіп памʼятає, що ви обрали. | ![Малюємо петлю](docs/images/overlay-drawing-uk.png) **Обведіть.** Широка біла лінія з кольоровим сяйвом, що йде за рукою. |
| ![Виділення чекає з кнопками](docs/images/overlay-actions-uk.png) **Ще нічого не надіслано.** Підправте краї й оберіть, що з ним буде. | ![Виділення тексту на застиглому екрані](docs/images/overlay-text-uk.png) **Проведіть по тексту — і отримаєте текст**, а не його картинку. |
...
стануть виділюваними, як текст у браузері. Проведіть по реченню й натисніть
*Enter*, щоб скопіювати, або *T*, щоб узяти все знайдене.

Працює `tesseract` на вашій машині. Нічого не вивантажується, ключі не потрібні,
