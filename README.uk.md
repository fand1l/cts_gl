...
| ![Виділення чекає з кнопками](docs/images/overlay-actions-uk.png) **Ще нічого не надіслано.** Підправте краї й оберіть, що з ним буде. | ![Виділення тексту на застиглому екрані](docs/images/overlay-text-uk.png) **Проведіть по тексту — і отримаєте текст**: шукатимуться слова, а не картинка. |
